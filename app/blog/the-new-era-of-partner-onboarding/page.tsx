...
export default function TheNewEraOfPartnerOnboardingPage() {
  return (
    <div style={{
      minHeight: '100vh',
      ...
      <article style={{
        ...
        <header style={{ marginBottom: '2rem' }}>
          <h1 style={{
            ...
            The New Era of Partner Onboarding
          </h1>
          <p style={{
            fontSize: '1.1rem',
            color: 'var(--text)',
            ...
            <time dateTime="2025-11-23">November 23, 2025</time> • by Dammy Henry
          </p>
        </header>

        <section style={{ marginBottom: '2rem' }}>
          <p style={{ fontSize: '1.2rem', fontWeight: '600', marginBottom: '1rem' }}>
            Onboarding used to take weeks—now it can take hours.
          </p>
          <p>
