...
export default function ApisVsEdiTheRealStoryPage() {
  return (
    <div style={{
      minHeight: '100vh',
      ...
      <article style={{
        ...
        <header style={{ marginBottom: '2rem' }}>
          <h1 style={{
            ...
            APIs vs. EDI: The Real Story Behind the Hype
          </h1>
          <p style={{
            fontSize: '1.1rem',
            color: 'var(--text)',
            ...
            <time dateTime="2025-10-12">October 12, 2025</time> • by Dammy Henry
          </p>
        </header>
